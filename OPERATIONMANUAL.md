...
- MCP tools: `agent-harness-kit`, `codetree` (deep-dive on symbols/files), filesystem, GitNexus (graph/flow context), Semble, through `bins/shims/*`
...
10. `evidence/graph/semble-searches.json`
11. `findings/normalized/findings.json`
12. `findings/triaged/findings.json`
13. `security/executive-summary.md`
14. `security/detailed-report.md`
15. `review/rescore-report.md`
